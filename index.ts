...
/**
 * Default subagent session root under the active Pi profile.
 * Individual runs are stored beneath:
 *   ~/.pi/agent/sessions/subagents/<runId>/
 */
function getSubagentSessionRoot(_parentSessionFile: string | null): string {
	const agentDir = process.env.PI_CODING_AGENT_DIR || path.join(os.homedir(), ".pi", "agent");
	return path.join(agentDir, "sessions", "subagents");
}
